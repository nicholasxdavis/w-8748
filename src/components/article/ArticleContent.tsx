...
const ArticleContent = ({
  ...
  >
    <div className="w-80 max-w-sm sm:max-w-md lg:max-w-2xl xl:max-w-4xl mx-auto bg-black/20 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 xl:p-12 border border-white/10 space-y-3 sm:space-y-4 lg:space-y-6 xl:space-y-8 min-h-[calc(20vh+30px)] lg:min-h-[calc(40vh+60px)]">
