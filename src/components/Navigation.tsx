...
const Navigation = () => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-gradient-to-br from-gray-900/98 via-black/98 to-gray-900/98 backdrop-blur-3xl rounded-3xl shadow-2xl overflow-hidden max-h-[85vh] border border-gray-700/40">
          <div className="p-6 border-b border-gray-700/30 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <input
                  ...
                  className="w-full bg-transparent text-xl font-medium outline-none placeholder-gray-400 text-white border-0 ring-0 focus:ring-0 focus:outline-none"
                  autoFocus
                />
                <p className="text-gray-400 text-sm mt-1 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
          ...
          <div className="max-h-[65vh] overflow-y-auto scrollbar-hide">
            {!searchValue && (
              <div className="p-10 text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl backdrop-blur-sm border border-gray-700/30">
            ...
            {isLoading && searchValue && (
              <div className="p-10 text-center">
                ...
                <p className="text-gray-400 text-base font-medium">Searching the universe of knowledge...</p>
              </div>
            )}
            ...
            {!isLoading && searchValue && searchResults && searchResults.length === 0 && (
              <div className="p-10 text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-3">No discoveries found</h3>
              ...
              <div className="p-4">
                {searchResults.map((result, index) => (
                  <div
                    ...
                    className="flex items-center p-5 rounded-2xl cursor-pointer hover:bg-gradient-to-r hover:from-gray-800/60 hover:to-gray-700/60 transition-all duration-300 group mb-2 border border-transparent hover:border-gray-700/50 backdrop-blur-sm"
                  >
                    <div className="flex items-center w-full space-x-5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          {isNewsArticle(result) && (
                            <span className="bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs px-3 py-1.5 rounded-full font-bold shadow-lg animate-pulse">
                              BREAKING
                            </span>
                          )}
                        </div>
