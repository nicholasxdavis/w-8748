...
const AuthPromptDialog = ({
  ...
  return <AlertDialog open={open} onOpenChange={onOpenChange}>
      ...
      zIndex: 9999
    }} className="sm:max-w-md bg-zinc-950 border-zinc-800 rounded-xl py-6 px-6 relative max-w-[300px]">
        <button onClick={() => onOpenChange(false)} className="absolute top-4 right-4 p-1 rounded-full hover:bg-zinc-800 transition-colors">
        ...
        <AlertDialogAction onClick={handleSignIn} className="w-full bg-blue-600 hover:bg-blue-700 text-white border-0 mt-4">
          Sign In
        </AlertDialogAction>
      </AlertDialogContent>
    </AlertDialog>;
